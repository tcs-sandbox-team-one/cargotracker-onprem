...
MYSQLJDBC=AdminTask.createJDBCProvider('[-scope Cell=DefaultCell01 -databaseType User-defined -implementationType "com.mysql.jdbc.jdbc2.optional.MysqlConnectionPoolDataSource" -name "MySQL JDBC Provider" -classpath [/demo/mysqldrivers/mysql-connector-java-8.0.17.jar ] ]')
#Create Datasources
