...
AdminTask.createDatasource('"MYSQL JDBC Provider(cells/DefaultCell01/nodes/DefaultNode01|resources.xml#JDBCProvider_1598264821725)"', '[-name "Mysql Datasource" -jndiName jdbc/mysqlds -dataStoreHelperClassName com.ibm.websphere.rsadapter.GenericDataStoreHelper -containerManagedPersistence true -componentManagedAuthenticationAlias DefaultNode01/mysqlDb ]')
AdminConfig.create('MappingModule', '(cells/DefaultCell01/nodes/DefaultNode01|resources.xml#DataSource_1598422237965)', '[[authDataAlias DefaultNode01/mysqlDb] [mappingConfigAlias DefaultPrincipalMapping]]')
AdminConfig.modify('(cells/DefaultCell01/nodes/DefaultNode01|resources.xml#CMPConnectorFactory_1598422238000)', '[[name "Mysql Datasource_CF"] [authDataAlias "DefaultNode01/mysqlDb"] [xaRecoveryAuthAlias ""]]')
AdminConfig.create('MappingModule', '(cells/DefaultCell01/nodes/DefaultNode01|resources.xml#CMPConnectorFactory_1598422238000)', '[[authDataAlias DefaultNode01/mysqlDb] [mappingConfigAlias DefaultPrincipalMapping]]')

AdminConfig.modify('(cells/DefaultCell01/nodes/DefaultNode01|resources.xml#J2EEResourceProperty_1598422238200)', '[[name "serverName"] [type "java.lang.String"] [description ""] [value "10.242.0.6"] [required "false"]]')
AdminConfig.modify('(cells/DefaultCell01/nodes/DefaultNode01|resources.xml#J2EEResourceProperty_1598422238200)', '[[name "portNumber"] [type "java.lang.String"] [description ""] [value "6603"] [required "false"]]')
AdminConfig.modify('(cells/DefaultCell01/nodes/DefaultNode01|resources.xml#J2EEResourceProperty_1598422238200)', '[[name "databaseName"] [type "java.lang.String"] [description ""] [value "cargotracker"] [required "false"]]')
AdminConfig.modify('(cells/DefaultCell01/nodes/DefaultNode01|resources.xml#J2EEResourceProperty_1598422238200)', '[[name "user"] [type "java.lang.String"] [description ""] [value "root"] [required "false"]]')
AdminConfig.modify('(cells/DefaultCell01/nodes/DefaultNode01|resources.xml#J2EEResourceProperty_1598422238200)', '[[name "password"] [type "java.lang.String"] [description ""] [value "password"] [required "false"]]')
