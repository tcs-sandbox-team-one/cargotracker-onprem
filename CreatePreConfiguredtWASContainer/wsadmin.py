...
MYSQLJDBC=AdminTask.createJDBCProvider('[-scope Cell=DefaultCell01 -databaseType User-defined -providerType "User-defined JDBC Provider" -implementationType "User-defined" -implementationClassName "com.mysql.jdbc.jdbc2.optional.MysqlConnectionPoolDataSource" -name "MySQL JDBC Provider" -classpath [/demo/mysqldrivers/mysql-connector-java-8.0.17.jar ] ]')
#Create Datasources
